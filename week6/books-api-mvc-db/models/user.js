  ...
  // Getting all Users
   ...
   // Getting users byId
    ...
    static async createUser(user) {
        ...
        // Retrieve the newly created users using its ID
      ...
      static async updateUser(id, updatedUser) {
        ...
        const sqlQuery = `UPDATE Users SET title = @username, email = @email WHERE id = @id`; // Parameterized query
        ...
        return this.getUserById(id); // returning the updated users data
      }
